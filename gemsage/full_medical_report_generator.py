                ...
                <div class="cop-item">
                    ...
                    <div class="cop-metrics">
                        <div class="metric-item">
                            <div class="metric-label">总位移:</div>
                            <div class="metric-value">{{ left_cop_displacement }} mm</div>
                        </div>
                        <div class="metric-item">
                            <div class="metric-label">摆动面积:</div>
                            <div class="metric-value">{{ left_sway_area }} mm²</div>
                        </div>
                    </div>
                </div>
                <div class="cop-item">
                    <div class="cop-title">右脚 COP 轨迹</div>
                    <div class="cop-chart">COP轨迹图</div>
                    <div class="cop-metrics">
                        <div class="metric-item">
                            <div class="metric-label">总位移:</div>
                            <div class="metric-value">{{ right_cop_displacement }} mm</div>
                        </div>
                        <div class="metric-item">
                            <div class="metric-label">摆动面积:</div>
                            <div class="metric-value">{{ right_sway_area }} mm²</div>
                        </div>
                    </div>
                </div>
            </div>
...
def generate_sample_report():
    ...
    data = {
        ...
        # COP数据
        'left_cop_displacement': '156.8',
        'left_sway_area': '45.2',
        'right_cop_displacement': '162.3',
        'right_sway_area': '48.7',
